...
[![Go Report Card](https://goreportcard.com/report/github.com/ellojess/makesite)](https://goreportcard.com/report/github.com/ellojess/makesite)
...
- [x] Add any third party library to your project to enhance it's functionality. Some ideas you might consider include **_(CHOOSE ONLY ONE)_**:
    ...
    - [x] **_FILL IN THE BLANK_**: `I will use the translate library in my Static Site Generator project. The documentation is located here. My goal is to use it to translate content on the page using Google Translate.`
- [x] **Add, commit, and push to GitHub**.
